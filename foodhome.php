...
<select class="DescriptionList">
    <option value="All">All</option>
    <option value="FishsAndSeafood">Fish & Seafood</option>
...
<!--</form>-->
    ...
    Email: info@restaurantmrandmrs.nl</br></br>
    Address: Lange Veerstraat 4</br></br></p>
    <p class = "price" >€45</p>
...
<div class = "BackgroundRestaurant3">
	<h1 class = "booknowtext3">Book Now!</h1>
  <div class="time1restaurant3" style=" text-align: center;">
    17:00  
  </div>
		<!--<a  href="DanceTicketFriday.php"> -->
  <div class="time1restaurant3" style=" text-align: center;">
...
<div class = "BackgroundRestaurant5">
	<h1 class = "booknowtext3">Book Now!</h1>
  <div class="time1restaurant5" style=" text-align: center;">
    17:00  
  </div>
		<!--<a  href="DanceTicketFriday.php"> -->
  <div class="time1restaurant5" style=" text-align: center;">
...
<div class = "BackgroundRestaurant6">
	<h1 class = "booknowtext3">Book Now!</h1>
  <div class="time1restaurant6" style=" text-align: center;">
    16:30  
  </div>
		<!--<a  href="DanceTicketFriday.php"> -->
  <div class="time1restaurant6" style=" text-align: center;">
...
<div class = "BackgroundRestaurant7">
	<h1 class = "booknowtext2">Book Now!</h1>
		<div class="time1restaurant7" style=" text-align: center;">
    17:30  
  </div>
		<!--<a  href="DanceTicketFriday.php"> -->
  <div class="time1restaurant7" style=" text-align: center;">
...
<div class = "GoldenBull">
    ...
    Address: Zijlsstraat 39</br></br></p>
    <p class = "price" >€35</p>
	
</div>
<div class = "BackgroundRestaurant8">
	<h1 class = "booknowtext2">Book Now!</h1>
		<div class="time1restaurant8" style=" text-align: center;">
    17:30  
  </div>
		<!--<a  href="DanceTicketFriday.php"> -->
  <div class="time1restaurant8" style=" text-align: center;">
