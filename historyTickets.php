			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>$ <?php echo number_format($values["amount"] * $values["price"], 2);?></td>
						<td><a href="index.php?action=delete&id=<?php echo $values["ticket_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
					<?php
